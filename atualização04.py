...
# Inserir fórmulas para calcular Total Receitas
...
for col1 in range(2, 14):  
    ...
    celula_total1.value = f"=SUM({chr(64 + col)}12:{chr(64 + col1)}17)"
...
for col2 in range(2, 14):  
    celula_total2= aba.cell(row=3, column=col2)
    celula_total2.value = f"=SUM({chr(64 + col)}9:{chr(64 + col2)}18)"
    celula_total2.alignment = Alignment(horizontal="center", vertical="center")
    celula_total2.font = Font(bold=16)
    celula_total2.fill = PatternFill(start_color="90ee90", end_color="90ee90", fill_type="solid")  
